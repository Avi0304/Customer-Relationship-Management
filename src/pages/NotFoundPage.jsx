      ...
      <div className="max-w-4xl w-full text-center">
        <div className="relative h-64 md:h-80 mb-12">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-[180px] md:text-[250px] font-black text-slate-300/90 select-none">
              403
            </div>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="absolute top-50 left-1/5 transform -translate-x-1/2">
              ...
              >
                ...
                {/* Hair */}
                <path
                  d="M72 45 Q100 5 128 45 Q118 15 82 15 Q72 30 72 45"
                  fill="#1f2937"
                />
                {/* Eyes */}
                ...
                {/* Nose */}
                <path
                  d="M99 52 Q100 56 101 52"
                  stroke="#cc9c78"
                  strokeWidth="1.2"
                />
                {/* Mouth */}
                <path
                  d="M88 64 Q100 70 112 64"
                  stroke="#e11d48"
                  strokeWidth="2"
                  fill="none"
                />
                ...
                <path
                  d="M70 85 Q100 95 130 85 Q135 120 130 165 Q100 180 70 165 Q65 120 70 85"
                  fill="#ef4444"
                />
                <polygon points="100,85 110,105 90,105" fill="#fef2f2" />{" "}
                {/* New Collar */}
                {/* New Sleeves */}
                <path
                  d="M55 95 Q50 120 55 140 Q60 145 65 140 Q70 120 65 95 Z"
                  fill="#ef4444"
                />
                <path
                  d="M145 95 Q150 120 145 140 Q140 145 135 140 Q130 120 135 95 Z"
                  fill="#ef4444"
                />
                {/* Arms */}
                <path
                  d="M53 140 Q55 160 60 160 Q65 160 67 140"
                  fill="#fcd5b4"
                />
                <path
                  d="M147 140 Q145 160 140 160 Q135 160 133 140"
                  fill="#fcd5b4"
                />
            ...
            <div className="absolute bottom-0 right-1/5 transform translate-x-1/2 scale-90">
              ...
              >
                ...
                {/* Shirt with collar */}
                <path
                  d="M70 85 Q100 95 130 85 Q135 130 130 165 Q100 180 70 165 Q65 130 70 85"
                  fill="#6366f1"
                />
