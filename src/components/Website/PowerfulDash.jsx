...
import { Button, TextField, InputAdornment, Select, MenuItem, Tabs, Tab } from '@mui/material';
...
function PowerfulDash() {
    ...
    const leads = [
        { name: "Amit Sharma", email: "amit.sharma@example.com", phone: "9876543210", status: "New" },
        { name: "Priya Verma", email: "priya.verma@example.com", phone: "9865432198", status: "Contacted" },
        { name: "Rajesh Kumar", email: "rajesh.kumar@example.com", phone: "8765432109", status: "Converted" },
        { name: "Neha Gupta", email: "neha.gupta@example.com", phone: "9754321098", status: "New" },
        { name: "Vikram Singh", email: "vikram.singh@example.com", phone: "8643210987", status: "Contacted" },
        { name: "Anjali Mehta", email: "anjali.mehta@example.com", phone: "7532109876", status: "Converted" },
        { name: "Suresh Patel", email: "suresh.patel@example.com", phone: "6421098765", status: "New" },
    ];
    ...
    const appointments = [
        { customer: "L&T Infotech", contact: "Rahul Kapoor", type: "Strategy Session", date: "2025-02-20", time: "4:00 PM", duration: "30 min", status: "Confirmed" },
    ...
    return (
        <section className="w-full mx-auto py-12 md:py-24 lg:py-15 bg-gray-50">
                ...
                {activeTab === "dashboard" && (
                    <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            {[
                                { title: "Total Revenue", value: "$45,231.89", change: "+20.1%", icon: <FaRupeeSign /> },
                                { title: "Sales", value: "+12,234", change: "+19%", icon: <FaChartBar /> },
                                { title: "Active Customers", value: "+573", change: "+201", icon: <FaUsers /> },
                                { title: "Active Deals", value: "+24", change: "+4", icon: <FaUserPlus /> },
                            ].map((item) => (
                                <div key={item.title} className="p-4 bg-white rounded-lg shadow-md">
                                    <div className="flex justify-between items-start">
                                        <h3 className="text-sm font-medium">{item.title}</h3>
                                        <div className="text-xl text-gray-500">{item.icon}</div>
                                    </div>
                                    <p className="text-2xl font-bold mt-2">{item.value}</p>
                                    <p className="text-xs text-green-500">{item.change} from last month</p>
                                </div>
                            ))}
                        </div>
                ...
                {activeTab === "tasks" && (
                    <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="mt-4 flex justify-center  gap-4">
                            <button className="px-4 py-2 bg-blue-500 text-white rounded-md shadow-md">All</button>
                            <button className="px-4 py-2 bg-gray-400 text-white rounded-md shadow-md">Pending</button>
                            <button className="px-4 py-2 bg-gray-400 text-white rounded-md shadow-md">Completed</button>
                        </div>
                            ...
                            {tasks.map((task, index) => (
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 flex items-center gap-2"> <HiBuildingOffice /> {task.company}</p>
                                    </div>
                    ...
                    <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button variant="contained" sx={{ backgroundColor: "#9C27B0", color: "white" }}>
                                    EXPORT TO EXCEL
                                </Button>
                            </div>
                        </div>
                            ...
                            <table className="w-full rounded-lg">
                                ...
                                <tbody>
                                    {leads
                                        ...
                                        .filter((lead) => statusFilter === "All Status" || lead.status === statusFilter)
                                        .map((lead, index) => (
