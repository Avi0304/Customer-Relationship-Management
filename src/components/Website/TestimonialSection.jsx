                ...
                <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3">
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-lg flex flex-col h-full">
                        <div className="flex flex-col gap-4 flex-grow">
                            ...
                            <p className="text-lg text-gray-800">
                                "This CRM has transformed how we manage our customer relationships. The dashboard gives us instant
                                insights, and the task management keeps our team organized."
                            </p>
                        </div>
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-lg flex flex-col h-full">
                        <div className="flex flex-col gap-4 flex-grow">
                            <FaQuoteRight size={30} className="text-black"/>
                            <p className="text-lg text-gray-800">
                                "The lead management feature has increased our conversion rate by 40%. We can now track every interaction
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-lg flex flex-col h-full">
                        <div className="flex flex-col gap-4 flex-grow">
                            <FaQuoteRight size={30} className="text-black"/>
                            <p className="text-lg text-gray-800">
                                "The appointment scheduling feature has eliminated the back-and-forth emails. Our clients love the
                                seamless experience."
                            </p>
                        </div>
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Customer Success Manager, Retail Solutions</p>
                            </div>
                        </div>
                    </div>
